...
function PrincipalSection() {
  return (
    <>
    {/* id="pricing" */}
        <div id="scrollspyHeading5"  className={styles.wholePage}>
            ...
            <div className={styles.featuresPlans} id="features">
              <ul className={styles.greenarrowbullet}>
                <li>
                 ...
                 <a  className={styles.textt}>1 Day Pass</a> 
                </li>
                <br></br>
                <li>
                  <span>
                 ...
                 <a className={styles.textt}> Free Gym Access</a>
                </li>
                <br></br>
                <li>
                  <span>
             ...
             <a  className={styles.textt}> 24 Hour Accces</a>
                </li>
              </ul>
            </div>
